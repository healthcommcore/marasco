...
<div class="<?php echo $this->params->get('pageclass_sfx'); ?>">
	<div id="page" class="full-article">
		...
		<div class="component-header"><h1 class="componentheading"><?php echo $this->escape($this->params->get('page_title')); ?></h1></div>
		<?php endif; ?>
		...
		<span class="small">
			<a href="<?php echo $this->article->urls; ?>" target="_blank"><?php echo $this->article->urls; ?></a>
		</span>
		<?php endif; ?>

...
<script type="text/javascript">
	function initialize(){
	var latlng = new google.maps.LatLng(42.3382909, -71.1077132);
	var mapOptions = {
		zoom:12,
		center: latlng,
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-26938036-1']);
  ...
  (function() {
	...
	<body onload="initialize()" id="ff-<?php echo $fontfamily; ?>" class="<?php echo $fontstyle; ?> <?php echo $tstyle; ?> <?php echo $mstyle; ?> <?php echo $h3style; ?> iehandle">
				...
				<div id="main-body">
					...
					<div id="maincol">
						<div class="main-height">
							...
							<?php endif; ?>
								<?php if (showModuleSlider("mid-top")) : ?>
								<div id="moduleslider-size">
	    							<?php displayTabs($this); ?>
	    						</div>
	    						<?php endif; ?>
							...
							<?php if (showModuleSlider("mid-bottom")) : ?>
		...
		<?php if (showModuleSlider("bottom")) : ?>
		...
		<?php endif; ?>
		<?php if ($this->countModules('user7') or $this->countModules('user8') or $this->countModules('user9') or $this->countModules('user10') or $this->countModules('debug')) : ?>
		<div id="bottom">
			<?php if($fwrap == "false") : ?>
			<div class="wrapper">
			<?php endif; ?>
